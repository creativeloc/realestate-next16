...
export default function Modal({
  ...
  return (
    ...
    >
      ...
      {/* modal */}
      <div
        className={`relative z-10 w-full max-w-lg rounded-2xl bg-white shadow-2xl transform transition-all duration-700 ${isOpen ? "opacity-100 translate-y-0" : "opacity-0 translate-y-full"}`}
      >
        {/* header */}
