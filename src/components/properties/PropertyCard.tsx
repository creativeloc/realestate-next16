  ...
  return (
    ...
    >
      <div className="w-full h-full relative">
        ...
        {/* top badge */}
        <div className="absolute left-5 top-5 z-20 rounded-full bg-white/80 px-4 py-2 text-sm font-semibold text-primary border border-primary/80">
            ...
            <div>
              {property.status === "rent" ? (
                <h3 className="text-3xl font-bold text-white flex items-center">
                  ...
                  <span className="text-sm text-white/70 px-1">/Month</span>
                </h3>
              ) : (
